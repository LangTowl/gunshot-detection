...
from audio_input import volume_queue, spectrogram_queue, renderer_queue, record_audio
...
# ---- SUPPRESS macOS IMK DEBUG OUTPUT ----
def suppress_mac_debug_output():
    sys.stderr.flush()
    devnull = os.open(os.devnull, os.O_WRONLY)
    os.dup2(devnull, 2)

suppress_mac_debug_output()
# -----------------------------------------
...
if __name__ == "__main__":
    ...
    root = tk.Tk()
    app = AudioRenderer(root, stop_event, volume_queue, renderer_queue)
