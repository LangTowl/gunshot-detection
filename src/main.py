...
from model_utils import prediction_decimal, samples_sniffed, model_prediction, gunshots_detected, average_volume, last_volume
...
if __name__ == "__main__":
    ...
    animation_thread = threading.Thread(target = volume_animation_bar, args = (stop_event, volume_queue, prediction_decimal, samples_sniffed, gunshots_detected, average_volume, last_volume))
