...
def volume_animation_bar(stop_event, audio_queue, prediction, chunk_duration = 0.01, max_length=40):
    ...
    while not stop_event.is_set():
        try:
            ...
            sys.stdout.write(f"\r|{bar}| {percentage} Prediction: {prediction.value} ")   # Write to screen
